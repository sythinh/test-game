...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-full md:h-svh flex flex-col-reverse  justify-center items-center text-center text-white bg-hero-bg-mobile md:bg-hero-bg-desktop bg-cover bg-center bg-no-repeat mx-auto px-4">
      ...
      <div className="flex flex-col w-full md:w-[860px] z-10 mt-20">
        <div className="flex flex-col md:flex-row items-center justify-center text-[40px] leading-[50px] md:text-7xl font-bold mt-6 mb-6 py-5 text-center">
          <h2>{t("title")}&nbsp;</h2>
          <h2>{t("title2")}</h2>
        </div>
