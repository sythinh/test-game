...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-full md:h-screen flex flex-col-reverse  justify-center items-center text-center text-white bg-hero-bg-mobile md:bg-hero-bg-desktop bg-cover bg-center bg-no-repeat mx-auto px-4">
      ...
      <div className="flex flex-col w-full md:w-[756px] z-10 mt-20">
        <h1 className="text-[40px] leading-[50px] md:text-6xl font-bold mt-6 mb-6 px-10 text-center">
          We're Getting Ready
        </h1>
